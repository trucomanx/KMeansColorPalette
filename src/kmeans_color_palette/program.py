...
from kmeans_color_palette.desktop import    create_desktop_file
from kmeans_color_palette.desktop import    create_desktop_directory
from kmeans_color_palette.desktop import    create_desktop_menu
from kmeans_color_palette.modules.wabout    import show_about_window
from kmeans_color_palette.modules.resources import resource_path
...
class ColorPaletteGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.btn_file.setIcon(QIcon(resource_path('icons', 'open_file.png')))
        ...
        self.btn_process.setIcon(QIcon(resource_path('icons', 'system.png')))
        ...
        self.btn_generate.setIcon(QIcon(resource_path('icons', 'image.png')))
    ...
    def update_colors_gui(self):
        ...
        for cdata in self.colors_data:
            ...
            chk = QCheckBox()
            img_path = resource_path('icons', 'check.svg')
